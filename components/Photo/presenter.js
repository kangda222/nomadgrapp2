...
const Photo = props => (
  <View style={styles.photo}>
    ...
    >
      <View style={styles.header}>
        ...
        <View>
          ...
          {props.location && <Text style={styles.author}>{props.location}</Text>}
        </View>
      </View>      
    </TouchableOpacity>
    <FadeIn>
    ...
    <View style={styles.photoMeta}>
      <PhotoActions isLiked={props.isLiked} likeCount={props.likeCount} handlePress={props.handlePress} getLikes={props.getLikes} photoId={props.id}/>
